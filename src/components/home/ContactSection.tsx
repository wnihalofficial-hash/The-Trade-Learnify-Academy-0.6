      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-white mb-8">For More Details Call Us</h3>
              <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border border-green-500/20 rounded-xl p-6 mb-8">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-green-400">+91 9373228941</p>
            ...
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-white">Contact Details</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h5 className="text-white font-semibold mb-2">Contact Numbers</h5>
                  <div className="space-y-1">
                    <p className="text-gray-300">+91 9373228941</p>
                    <p className="text-gray-300">+91 7972299513</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <a
                ...
                className="inline-flex items-center space-x-3 bg-green-500 hover:bg-green-400 text-black px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-green-500/25 transform hover:scale-105"
              >
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-green-500/20">
            <h3 className="text-2xl font-bold text-white mb-8">Send Us Your Details</h3>
